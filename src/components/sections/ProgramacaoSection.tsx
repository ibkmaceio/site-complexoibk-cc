        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          <div className="lg:col-span-1">
            <FadeIn>
              ...
              <h2 className="font-display font-900 text-[clamp(2.5rem,4vw,3.5rem)] text-white leading-tight tracking-tight mb-4">
              ...
              dia.cultos.map((culto, i) => (
                <FadeIn key={`${dia.dia}-${i}`} delay={i * 0.08}>
                  <motion.div
                    ...
                    className="group relative overflow-hidden border border-white/8 rounded p-6 bg-[#111] hover:border-[#E84C1E]/40 hover:bg-[#130a09] transition-colors duration-300"
                  >

                    {/* Acento laranja ao hover */}
                    ...
                    <h3 className="font-display font-800 text-xl text-white mb-3 group-hover:text-[#E84C1E] transition-colors">
                      {culto.nome}
                    </h3>
                    <p className="font-display font-700 text-3xl text-white/25">
                      {culto.horario}
                    </p>
                  </motion.div>
                </FadeIn>
