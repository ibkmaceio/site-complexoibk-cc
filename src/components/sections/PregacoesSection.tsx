        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16">
          ...
          <FadeIn delay={0.1}>
            <a
              ...
              className="flex items-center gap-2 text-white/40 hover:text-white font-display font-700 text-sm transition-colors group shrink-0"
            >
              {COPY.pregacoes.cta}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {VIDEOS.slice(0, 4).map((v, i) => (
            <FadeIn key={v.id} delay={i * 0.07}>
              ...
              >
                <div className="relative aspect-video bg-[#111] rounded overflow-hidden mb-3">
                  <img
                    src={v.thumbnail}
                    alt={v.titulo}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-9 h-9 flex items-center justify-center rounded-full bg-[#E84C1E]/80 group-hover:bg-[#E84C1E] group-hover:scale-110 transition-all">
