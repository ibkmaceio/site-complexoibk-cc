...
$sql_all = mysql_query("SELECT * FROM _videos WHERE slug = '{$slug}' ");
...
<head>
    ...
    <title>Videos IBK - <?php echo $dados_all['titulo']; ?></title>
...
<body>
					...
					<div class="title-int-text">
						<h1 class="pull-left">
							<div class="btn-ao-vivo">
								<a href="javascript:void();" class="active"><i class="fa fa-circle"></i> Videos  <i class="fas fa-angle-right"></i> <span><?php echo $dados_all['titulo']; ?></span></a>
							</div>
						</h1>
	...
	<div id="live">
		<iframe width="100%" class='video_institucional' style="margin-top: -10px;" src="https://www.youtube.com/embed/<?php echo $dados_all['embed']; ?>?&autoplay=1" frameborder="0" allow="encrypted-media" autoplay allowfullscreen></iframe>
	</div>
