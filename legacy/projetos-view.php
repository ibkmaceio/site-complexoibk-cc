...
$sql_views = mysql_query("UPDATE _projetos SET views = views+1 WHERE slug = '{$slug}' ");

$sql_all = mysql_query("SELECT * FROM _projetos WHERE slug = '{$slug}' ");
				...
				<div class="title-int-text">
					<h1>
						...
						<span> <?php echo $dados_all['titulo']; ?>
							<span style="color:#bca153; font-weight: 800; padding-left: 20px; top: 0px;"><i class="fa fa-calendar-o"></i> <?php echo $dia; ?> <?php echo $mes_completo; ?> '<?php echo $ano; ?></span>
						</span>
					</h1>
				</div>
			</div>
		...
		<div class="uk-card-media-left uk-cover-container">
			<div class="uk-inline-clip uk-transition-toggle" tabindex="0">
				...
				<?php } else { ?>
					...
					<img class="uk-transition-scale-up uk-transition-opaque" src="./cms/timthumb.php?src=./cms/assets/uploads/_PROJETOS/<?php echo $dados_all['img']; ?>&w=700&h=401"/>
				<?php } ?>
	...
	<div class="container" id="text-read">
		...
		<div class="row">
			<div class="col-sm-12 alinha-centro margin-auto">
				<a href="doacoes#realizar" class="prosseguir tira-padding-right">
					Quero realizar uma doação <i class="fas fa-hand-holding-heart"></i>
				</a>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="uk-grid-collapse uk-child-width-1-4@s uk-margin" uk-grid uk-lightbox="animation: scale">
					...
					<?php
			        $sql_3 = "SELECT * FROM _projetos as ga INNER JOIN _projetos_galeria
