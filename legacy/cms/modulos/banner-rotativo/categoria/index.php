...
<h3 class="uk-heading-line"><span>Categorias</span></h3>

<div class="pull-right">
    <a href="javascript:history.go(-1)" title="Voltar" class="uk-button uk-button-danger uk-button-small" uk-tooltip uk-icon="icon: chevron-left"></a>
    <a href="modulos/banner-rotativo/categoria/cadastrar" class="uk-button uk-button-success uk-button-small pull-right" title="Novo Registro" uk-tooltip>
    ...
    <table class="uk-table uk-table-hover uk-table-middle">
        <thead>
            <tr>
                ...
                <th class="uk-width-small">Slug</th>
        ...
        <tbody>
        	<?php
	        	$sql = "SELECT * FROM _destaques_categoria order by id DESC";
				$bd->consulta($sql);
				$bd->first();
				$row = $bd->getRows();
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                ...
                <td class="uk-table-link" width="35%">
                    <?php echo $dados['titulo']; ?>
                </td>
                <td class="uk-table-link" width="20%"><?php echo $dados['slug_cat_videos']; ?></td>
                ...
                <td class="uk-text-nowrap" width="12%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/banner-rotativo/categoria/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip href="#" uk-icon="icon: file-edit"></a></li>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/banner-rotativo/categoria/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
