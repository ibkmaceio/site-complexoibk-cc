...
<h3 class="uk-heading-line"><span>Programação</span></h3>

<?php if ($_SESSION['nivel'] == 1) {?>
<div class="pull-right">
    <a href="modulos/programacao/cadastrar" class="uk-button uk-button-success uk-button-small" title="Novo Registro" uk-tooltip>
...
<div class="uk-overflow-auto uk-background-muted">
    <table class="uk-table uk-table-hover uk-table-middle">
        ...
        <tbody>
        	<?php
				$sql = "SELECT * FROM _programacao WHERE ativo = 'S' ORDER BY id DESC";
				$bd->consulta($sql);
				$bd->first();
				$row = $bd->getRows();
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                ...
                <td class="uk-text-nowrap" width="25%"><span uk-icon="icon: calendar"></span><?php echo $dados['data']; ?></td>
                <td class="uk-text-truncate" width="6%">
                ...
                <td class="uk-text-nowrap" width="9%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/programacao/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip uk-icon="icon: file-edit"></a></li>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/programacao/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
