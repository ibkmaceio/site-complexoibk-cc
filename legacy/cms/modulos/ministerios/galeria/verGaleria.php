...
$sql = "SELECT * FROM _ministerios WHERE id = '".$_GET['id']."'";
$bd->consulta($sql);
$bd->first();
$row = $bd->getRows();
...
<a href="modulos/noticias/galeria/add.php?id=<?php echo $dados['id'];?>" title="Adicionar" class="uk-button uk-button-primary pull-right" uk-tooltip uk-icon="icon: plus"></a>
...
<div class="uk-background-muted uk-padding">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM _ministerios as ga INNER JOIN _ministerios_galeria
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/ministerios/galeria/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
