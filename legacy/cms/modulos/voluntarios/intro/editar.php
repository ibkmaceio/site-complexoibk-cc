...
$query2 = "SELECT * FROM _voluntarios_intro WHERE id = '".$_REQUEST['id']."'";
$bd->consulta($query2);
$bd->first();
$dados = $bd->getDados();
...
if($_POST['action'] == 'editar'){
    ...
    $sql = " UPDATE _voluntarios_intro SET
    titulo              = '".$_POST['titulo']."',
    texto               = '".$_POST['texto']."',
    ativo               = 'S'
    WHERE id = '".$_POST['id']."'
...
<div class="uk-overflow-auto uk-background-muted uk-padding">
    <form class="uk-form-stacked" action="" method="post" enctype="multipart/form-data">
        <div class="row">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <div class="uk-inline">
                            ...
                            <input class="uk-input uk-form-width-large" name="titulo" id="breve_descricao" type="text" placeholder="Digite um texto ..." value="<?php echo $dados['titulo']; ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="uk-margin">
                    <label class="uk-form-label" for="texto">Texto</label>
                    <div class="uk-form-controls">
                        <textarea name="texto" class="uk-textarea" placeholder="Digite um texto ..." rows="2"><?php echo $dados['texto']; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
