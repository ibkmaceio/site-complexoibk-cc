        ...
        <div class="row">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select class="uk-select" name="mes">
                            <option value="<?php echo $dados['mes']; ?>"><?php echo $dados['mes']; ?></option>
                            <option value="-">-</option>
            ...
            <div class="col-sm-2">
                <div class="uk-margin">
                    ...
                    <div class="uk-inline">
                        ...
                        <input class="uk-input uk-form-width-large" name="ano" type="text" placeholder="2019" value="<?php echo $dados['ano']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <textarea name="titulo" class="uk-textarea" placeholder="Digite um texto ..." rows="5"><?php echo $dados['titulo']; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
