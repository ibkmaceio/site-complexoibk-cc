...
$sql = "SELECT * FROM _institucional WHERE id = '".$_GET['id']."'";
$bd->consulta($sql);
$bd->first();
$row = $bd->getRows();
...
<a href="modulos/institucional/galeria/add.php?id=<?php echo $dados['id'];?>" title="Adicionar" class="uk-button uk-button-primary pull-right" uk-tooltip uk-icon="icon: plus"></a>
...
<div class="uk-background-muted uk-padding">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM _institucional as ga INNER JOIN _institucional_galeria
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/institucional/galeria/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
