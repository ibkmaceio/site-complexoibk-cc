...
$query2 = "SELECT * FROM _institucional WHERE id = '".$_GET['id']."'";
$bd->consulta($query2);
$bd->first();
$dados = $bd->getDados();
...
if($_POST['action'] == 'cadastrar'){
    ...
    $dir = $_SERVER['DOCUMENT_ROOT']."/cms/assets/uploads/_INSTITUCIONAL/";
    $dir2 = "./cms/assets/uploads/_INSTITUCIONAL/";
    ...
    foreach ($_FILES["imagem"]["error"] as $key => $error) {
        ...
        $sql_fotos = "INSERT INTO _institucional_galeria(
        id_galeria_album,
        slug_noticias,
        caminho,
        nome_arquivo
