...
<div class="pull-right">
    <a href="modulos/noticias/cadastrar" class="uk-button uk-button-success uk-button-small" title="Novo Registro" uk-tooltip>
        <span uk-icon="icon: plus-circle"></span>
    </a>
</div>

<div class="pull-right">
    <a href="modulos/noticias/categoria" class="uk-button uk-button-primary uk-button-small" title="Gerenciar Categorias" uk-tooltip>
        ...
        <tbody>
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                ...
                <td>
                    ...
                    <?php } else { ?>
                        <?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_NOTICIAS/".$dados['img']."&w=65&h=65' class='uk-preserve-width uk-border-circle' />";?>
                    <?php } ?>
                </td>
                ...
                <td class="uk-text-nowrap" width="15%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/noticias/galeria/verGaleria.php?id=<?php echo $dados['id'];?>" title="Galeria de Imagens" uk-tooltip href="#" uk-icon="icon: image"></a></li>
                        <li><a href="modulos/noticias/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip href="#" uk-icon="icon: file-edit"></a></li>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/noticias/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
