...
if($_POST['action'] == 'editar'){
    ...
    if($_FILES["banner"]["name"] != ""){
        ...
        if(sizeof($erro)){
            ...
            $imagem_dir  = $_SERVER['DOCUMENT_ROOT']."/cms/assets/uploads/_NOTICIAS/" . $imagem_nome;
...
<div class="uk-overflow-auto uk-background-muted uk-padding">
    <form class="uk-form-stacked" action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-sm-12">
                <?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_NOTICIAS/".$dados['img']."&h=175&w=220' class='thumbnail img-responsive' />";?>
