...
$slug = _retirar_acentuacao(strtolower($tag));

if($_POST['action'] == 'cadastrar'){

    $data = date('d/m/Y');

    $sql = "INSERT INTO _tags (
    slug,
    tag,
    ativo)
    VALUES (
...
<div class="uk-background-muted uk-padding">
    ...
    <form class="uk-form-stacked" id="form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="uk-margin">
                <label class="uk-form-label" for="">Nome da tag</label>
                    <div class="uk-inline">
                        <span class="uk-form-icon" uk-icon="icon: arrow-right"></span>
                        <input class="uk-input uk-form-width-large" name="tag" type="text" placeholder="Digite um texto ...">
                    </div>
                </div>
            </div>
        </div>
