...
<div class="pull-right">
	<a href="modulos/tags/cadastrar" class="uk-button uk-button-success uk-button-small" title="Novo Registro" uk-tooltip>
...
<div class="uk-overflow-auto uk-background-muted">
    <table class="uk-table uk-table-hover uk-table-middle">
        ...
        <tbody>
        	<?php
	        	$sql = "SELECT * FROM _tags order by id DESC";
				$bd->consulta($sql);
				$bd->first();
				$row = $bd->getRows();
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                ...
                <td class="uk-text-nowrap" width="12%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/tags/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip href="#" uk-icon="icon: file-edit"></a></li>
