...
<h3 class="uk-heading-line"><span>Eventos</span></h3>

<?php if ($_SESSION['nivel'] == 1) {?>
<div class="pull-right">
    <a href="modulos/eventos/cadastrar" class="uk-button uk-button-success uk-button-small" title="Novo Registro" uk-tooltip>
        <span uk-icon="icon: plus-circle"></span>
    </a>
</div>

<div class="pull-right">
    <a href="modulos/eventos/categoria" class="uk-button uk-button-primary uk-button-small" title="Gerenciar Categorias" uk-tooltip>
    ...
    <table class="uk-table uk-table-hover uk-table-middle">
        <thead>
            <tr>
                ...
                <th class="uk-width-small">Data Evento</th>
        ...
        <tbody>
        	<?php
	        	$sql = "SELECT * FROM _eventos order by id DESC";
				$bd->consulta($sql);
				$bd->first();
				$row = $bd->getRows();
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                <td>
                    ...
                    <?php } else { ?>
                        <?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_EVENTOS/".$dados['img']."&w=65&h=65' class='uk-preserve-width uk-border-circle' />";?>
                    <?php } ?>
                ...
                <td class="uk-text-nowrap" width="12%"><span uk-icon="icon: calendar"></span> <?php echo $dados['data_evento']; ?> </td>
                ...
                <td class="uk-text-nowrap" width="9%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/eventos/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip href="#" uk-icon="icon: file-edit"></a></li>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/eventos/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
