...
<div class="uk-overflow-auto uk-background-muted uk-padding">
    <form class="uk-form-stacked" action="" method="post" enctype="multipart/form-data">
        <div class="row">
               ...
               <div class="col-sm-3">
                <div class="uk-margin">
                    ...
                    <div class="uk-inline">
                        ...
                        <input class="uk-input uk-form-width-large" name="data_evento" id="data" type="text" placeholder="99/99/9999" value="<?php echo $dados['data_evento']; ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select class="uk-select" name="categoria_noticia">
                            ...
                            <?php
                            $sql = mysql_query("SELECT * FROM _eventos_categoria ORDER BY id ASC");
            ...
            <div class="col-sm-12">
                <?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_EVENTOS/".$dados['img']."&h=175&w=220' class='thumbnail img-responsive' />";?>
