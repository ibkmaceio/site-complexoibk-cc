...
<h3 class="uk-heading-line"><span>Projetos</span></h3>

<?php if ($_SESSION['nivel'] == 1) {?>
<div class="pull-right">
    <a href="modulos/projetos/cadastrar" class="uk-button uk-button-success uk-button-small" title="Novo Registro" uk-tooltip>
        <span uk-icon="icon: plus-circle"></span>
    </a>
</div>

<div class="pull-right">
    <a href="modulos/projetos/categoria" class="uk-button uk-button-primary uk-button-small" title="Gerenciar Categorias" uk-tooltip>
...
<div class="uk-overflow-auto uk-background-muted">
    <table class="uk-table uk-table-hover uk-table-middle">
        ...
        <tbody>
        	<?php
	        	$sql = "SELECT * FROM _projetos order by id DESC";
				$bd->consulta($sql);
				$bd->first();
				$row = $bd->getRows();
            ...
            <tr id="tr_<?php echo $dados['id'];?>">
                ...
                <td><?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_PROJETOS/".$dados['img']."&w=65&h=65' class='uk-preserve-width uk-border-circle' />";?></td>
                ...
                <td class="uk-text-nowrap" width="15%">
                    <ul class="uk-iconnav">
                        <li><a href="modulos/projetos/galeria/verGaleria.php?id=<?php echo $dados['id'];?>" title="Galeria de Imagens" uk-tooltip href="#" uk-icon="icon: image"></a></li>
                        <li><a href="modulos/projetos/editar.php?id=<?php echo $dados['id'];?>" title="Editar" uk-tooltip href="#" uk-icon="icon: file-edit"></a></li>
        ...
        $.confirm({
            ...
            buttons: {
                deleteUser: {
                    ...
                    action: function () {
                        $.ajax({
                            url: 'modulos/projetos/excluir.php',
                            type: 'POST',
                            data:{
                                id: id
                            },
