...
$query2 = "SELECT * FROM _projetos WHERE id = '".$_REQUEST['id']."'";
$bd->consulta($query2);
$bd->first();
$dados = $bd->getDados();
...
if($_POST['action'] == 'editar'){
    ...
    if($_FILES["banner"]["name"] != ""){
        ...
        if(sizeof($erro)){
            ...
            $imagem_dir  = $_SERVER['DOCUMENT_ROOT']."/cms/assets/uploads/_PROJETOS/" . $imagem_nome;
    ...
    if ($dados['titulo'] != $_POST['titulo']) {
        ...
        $sql_edit_galeria = " UPDATE _projetos_galeria SET
            slug_noticias = '".$slug."'
            ...
            if ($bd->consulta($sql_edit_galeria)) {
                ...
                echo "<script type='text/javascript'>alert('Erro ao atualizar tabela PROJETOS > GALERIA');</script>";
            }
    }
...
<div class="uk-overflow-auto uk-background-muted uk-padding">
    <form class="uk-form-stacked" action="" method="post" enctype="multipart/form-data">
        <div class="row">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select class="uk-select" name="categoria_noticia">
                            ...
                            <?php
                            $sql = mysql_query("SELECT * FROM _projetos_categoria ORDER BY id ASC");
            ...
            <div class="col-sm-12">
                <?php echo "<img src='./timthumb.php?src=./cms/assets/uploads/_PROJETOS/".$dados['img']."&h=175&w=220' class='thumbnail img-responsive' />";?>
