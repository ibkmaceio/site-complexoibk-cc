...
$sql_views = mysql_query("UPDATE _midia SET views = views+1 WHERE slug = '{$slug}' ");

$sql_all = mysql_query("SELECT * FROM _midia WHERE slug = '{$slug}' ");
	...
	<div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin tira-padding-right" uk-grid style="margin-top: -6px;">
		<div class="uk-card-media-left uk-cover-container">
			<div class="uk-inline-clip uk-transition-toggle" tabindex="0">
				...
				<img class="uk-transition-scale-up uk-transition-opaque" src="./cms/timthumb.php?src=./cms/assets/uploads/_MIDIA/<?php echo $dados_all['img']; ?>&w=700&h=401"/>
				<?php } ?>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="uk-grid-collapse uk-child-width-1-4@s uk-margin" uk-grid uk-lightbox="animation: scale">
					...
					<?php
			        $sql_3 = "SELECT * FROM _midia as ga INNER JOIN _midia_galeria
					...
					<div class="uk-inline-clip uk-transition-toggle " tabindex="0">
						<a class="uk-inline" href="<?php echo $dados_pic['caminho']; ?>" data-caption="<?php echo $dados_all['titulo']; ?>">
							<img src="./cms/timthumb.php?src=<?php echo $dados_pic['caminho']; ?>&w=300&h=210&q=100" class='uk-transition-scale-up uk-transition-opaque'/>
