...
if($_POST['action'] == 'envia_voluntario'){

    for ($i=0; $i < sizeof($_POST['ministerio']); $i++) {
        $ministerio_final .= $_POST['ministerio'][$i].", ";
    }
    $ministerio  = $ministerio_final;

    $sql = "INSERT INTO _voluntarios (
    ministerio,
    nome,
    email,
    dt_nascimento,
    ...
    $membro         = $_POST['membro'];
    $texto          = $_POST['texto'];
    $assunto        = "Cadastro de Voluntário IBK";
    ...
    $mail->setFrom('suporte@rota3.com.br', 'IBK Maceio');
            ...
            <tr>
                <td width="60%">
                    ...
                    <span style="line-height:1.5">
                        ...
                        <br>
                        Ministerios: <strong>'.$ministerio.'</strong><br>
                        Membro: <strong>'.$membro.'</strong><br><br>
                        Mensagem: <strong>'.$texto.'</strong><br>
                    </span>
                </td>
    ...
    if(!$mail->send()) {
        ...
        echo '<script type="text/javascript">alert("Seu cadastro foi enviado para equipe. Aguarde nosso contato!");</script>';
        echo "<meta http-equiv='refresh' content='0;URL=/'>";
    }
}
?>
